                ...
                <div className="tab container mx-auto ">
                    <Tabs defaultIndex={0} className=" " >
                        <TabList className="flex justify-evenly flex-wrap mb-10 ">
                            ...
                            <Tab>
                                <button type="button" className="font-medium border-b-2 hover:shadow-black bg-yellow-500 text-black  rounded-lg text-xl shadow-[offset_0_0_8px_rgba(0,0,0,0.6)]    px-5 py-1.5 text-center ">
                                    <div className="flex gap-2 items-center">
                            ...
                            <div className='  px-4 md:px-0 mb-16'>
                                ...
                                <div className=" flex justify-end">
                                    <div onClick={goToAdd}>
                                        <button
                                            type="button"
                                            className="focus:outline-none text-black bg-orange-400 shadow-md border hover:bg-orange-500 outline-0 font-medium rounded-lg text-sm px-5 py-2.5 mb-2" style={{ backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : '', color: mode === 'dark' ? 'white' : '', }} > <div className="flex gap-2 items-center">
