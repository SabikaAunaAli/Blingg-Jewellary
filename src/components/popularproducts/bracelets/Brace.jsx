...
export default function Brace() {
  const { rings, necklace, earings, Brace, pro, product } = products;
  ...
  return (
    <>
      ...
      >
        ...
        {showMessage && (
          <div className="bg-green-500 text-white text-center mt-3 py-2 mb-4">
            ...
            {Brace.map((bracelet, index) => (
              <div key={index} className=" border-gray-400 border p-4 rounded-lg shadow-lg">
                ...
                <div className="overflow-hidden relative ">
                  ...
                  <div className="inline-block rounded-full shadow-lg font-bold p-2 pl-3 pr-3 pt-3 pb-3 border border-orange-500 absolute top-32 left-4 sm:top-4 sm:left-56 md:left-40 lg:left-40 xl:left-56   2xl:left-72 hover:border-gray-600 hover:text-orange-400">
                 
                  <Link to={`/desc/${bracelet.id}`}>
                  <FaEye onClick={handleClick} />
                  </Link>
                  </div>
                  <div className=" rounded-full shadow-lg font-bold p-2 pl-3 pr-3 pt-3 pb-3 border border-orange-500 absolute top-20 left-4 sm:top-16 sm:left-56 md:left-40 lg:left-40 xl:left-56   2xl:left-72  hover:border-gray-600 hover:text-orange-400">
                    <FaShoppingCart onClick={() => addProductToCart(bracelet)} />
                  </div>
